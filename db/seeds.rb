...
r1 = Reservation.create(name: 'stephen', phone: '5164747688', date: '2013-03-22', day: 'fri', party_size: 2, est_wait: 20, act_wait: 23, is_waiting: true)
r2 = Reservation.create(name: 'john', phone: '9086421700', date: '2013-03-22', day: 'fri', party_size: 4, est_wait: 15, act_wait: 13, is_waiting: true)
r3 = Reservation.create(name: 'mack', phone: '5164747688', date: '2013-03-22', day: 'fri', party_size: 5, est_wait: 10, act_wait: 10, is_waiting: true)
r4 = Reservation.create(name: 'jill', phone: '5164747688', date: '2013-03-22', day: 'fri', party_size: 2, est_wait: 30, act_wait: 35, is_texted: true)
